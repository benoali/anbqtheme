                ...
                <div className="row">
                  <div className="col-xl-5 col-lg-6">
                    <div className="roadMap__content">
                      ...
                      <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor, incidunt modi eaque quibusdam facilis asperiores quae accusantium distinctio laudantium? Tempore consequuntur enim, laboriosam voluptatem nihil nostrum accusantium cumque possimus eos?.
                      </p>
